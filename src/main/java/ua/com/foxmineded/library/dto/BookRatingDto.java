...
public class BookRatingDto extends AbstractDto<Long> {
	...
	public boolean equals(Object o) {
	    ...
	    return Objects.equals(id, bookRatingDto.id) && 
	    		Objects.equals(bookReaderId, bookRatingDto.bookReaderId) &&
	    		Objects.equals(bookId, bookRatingDto.bookId) && 
	    		Objects.equals(rating, bookRatingDto.rating);
	}
