...
import ua.com.foxmineded.universitycms.dao.AuthorRepository;
import ua.com.foxmineded.universitycms.dto.AuthorDto;
import ua.com.foxmineded.universitycms.entities.impl.Author;
import ua.com.foxmineded.universitycms.exceptions.ServiceException;
import ua.com.foxmineded.universitycms.services.AuthorService;
...
public class AuthorServiceImpl implements AuthorService {
	...
	public Page<AuthorDto> findAll(Pageable pageable) {
		...
		return authors.map(new Function<Author, AuthorDto>() {
			@Override
			public AuthorDto apply(Author t) {
				return modelMapper.map(t, AuthorDto.class);
			}
		});
	}
