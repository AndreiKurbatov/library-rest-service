...
public class BookServiceImpl implements BookService {
	...
	public BookDto findById(Long id) throws ServiceException {
		return bookRepository.findById(id).map(value -> modelMapper.map(value, BookDto.class)).orElseThrow(() -> {
	...
	public BookDto findByIsbn(String isbn) throws ServiceException {
		return bookRepository.findByIsbn(isbn).map(value -> modelMapper.map(value, BookDto.class)).orElseThrow(() -> {
