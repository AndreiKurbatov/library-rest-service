...
class BookReaderControllerTest {
	...
	void testFindAll_AskFindAllEntities_AllEntitiesShouldBeFound200 () {
		...
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(BASE_URL + PORT + "/api/v1/book-readers/search/all")
			    .queryParam("pageable", 0);
		
		ResponseEntity<CustomPageImpl<BookReaderDto>> responseEntity = restTemplate.exchange(builder.toUriString(), HttpMethod.GET, null, new ParameterizedTypeReference<CustomPageImpl<BookReaderDto>>() {});
	...
	void testFindAllByAge_AskFindAllEntitiesByAge_AllEntitiesShouldBeFound200() {
		...
		UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(BASE_URL + PORT + "/api/v1/book-readers/search/age/12")
			    .queryParam("pageable", 0);
